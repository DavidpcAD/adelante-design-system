import{n as e}from"./chunk-jRWAZmH_.js";import{n as t,t as n}from"./QtyPill-Bn6pyCNf.js";var r,i,a,o,s,c,l,u,d,f,p,m;e((()=>{t(),r={title:`Components/QtyPill`,component:n,parameters:{layout:`centered`},argTypes:{variant:{control:{type:`inline-radio`},options:[`pendiente`,`incompleto`,`completo`,`sin-stock`]},mode:{control:{type:`inline-radio`},options:[`standard`,`pressed`]},size:{control:{type:`inline-radio`},options:[`sm`,`md`,`lg`]},value:{control:{type:`number`,min:0,max:999}}}},i={args:{value:3,variant:`pendiente`,size:`sm`}},a={args:{value:3,variant:`incompleto`,size:`sm`}},o={args:{value:3,variant:`completo`,size:`sm`}},s={args:{value:3,variant:`sin-stock`,size:`sm`}},c={args:{value:3,variant:`pendiente`,mode:`pressed`,size:`sm`}},l={args:{value:3,variant:`incompleto`,mode:`pressed`,size:`sm`}},u={args:{value:3,variant:`completo`,mode:`pressed`,size:`sm`}},d={args:{value:3,variant:`sin-stock`,mode:`pressed`,size:`sm`}},f={args:{value:5,variant:`incompleto`,size:`md`,onTap:()=>console.log(`tap`)}},p={args:{value:120,variant:`completo`,size:`lg`}},i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    value: 3,
    variant: "pendiente",
    size: "sm"
