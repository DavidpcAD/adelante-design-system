import{n as e}from"./chunk.js";import{n as t,t as n}from"./QuantitySelector.js";var r,i,a,o,s,c,l,u,d,f;e((()=>{t(),r={title:`Buttons/QuantitySelector`,component:n,parameters:{layout:`centered`},argTypes:{state:{control:{type:`inline-radio`},options:[`pendiente`,`incompleto`,`completo`,`sin-stock`]},mode:{control:{type:`inline-radio`},options:[`standard`,`pressed`]},value:{control:{type:`number`,min:0,max:999}}}},i={args:{value:3,state:`pendiente`}},a={args:{value:3,state:`incompleto`}},o={args:{value:3,state:`completo`}},s={args:{value:3,state:`sin-stock`}},c={args:{value:3,state:`pendiente`,mode:`pressed`}},l={args:{value:3,state:`incompleto`,mode:`pressed`}},u={args:{value:3,state:`completo`,mode:`pressed`}},d={args:{value:3,state:`sin-stock`,mode:`pressed`}},i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    value: 3,
    state: "pendiente"
  }
